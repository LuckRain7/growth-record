 ...
 * @LastEditTime : 2020-11-18 10:18:20
...
export default {
  ...
  methods: {
    ...
    editMoadlOk() {
      ...
      const options = {
        id: _date.key,
        stage: this.StageTranslation(_date.stage_txt),
        type: this.TypeTranslation(_date.type_txt),
        num: _date.num,
      };
      this.$message.success(JSON.stringify(options));
      console.log(" --- editRenderData --- ", this.editRenderData);
    },
